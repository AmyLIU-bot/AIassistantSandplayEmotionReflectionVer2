        ...
        <Card className="shadow-card border-0 backdrop-blur-sm bg-card/95">
          ...
          <CardContent className="px-5 pb-5">
            <form onSubmit={handleLogin} className="space-y-3">
              ...
              <Button type="button" variant="google" className="w-full h-9 text-sm font-medium rounded-lg gap-2.5" onClick={() => { localStorage.removeItem("sandbox_sessions"); navigate("/home"); }}>
