  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section ref={contentRef} className="relative z-10 h-screen flex flex-col">
        {/* Logo */}
        <div className="px-4 md:px-8 lg:px-12 pt-4 shrink-0">
          ...
          <div className="w-full max-w-6xl mx-auto h-full grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-8 items-stretch lg:overflow-hidden">
            ...
            <div className="relative h-full overflow-y-auto pr-2 space-y-3 pb-3">
              ...
              <div className="space-y-3">
                <h2 className="animate-fade-in-up animation-delay-100 text-3xl md:text-4xl font-bold leading-tight tracking-tight" style={{ color: 'hsl(150 15% 12%)' }}>
                  What is a Sandbox?
                </h2>

                <p className="animate-fade-in-up animation-delay-200 text-base leading-relaxed max-w-lg" style={{ color: 'hsl(150 8% 25%)' }}>
                ...
                <p className="animate-fade-in-up animation-delay-300 text-base leading-relaxed max-w-lg" style={{ color: 'hsl(150 8% 25%)' }}>
                  The system then reflects their emotions in a gentle and meaningful way.
                </p>
              </div>

              <div className="animate-fade-in-up animation-delay-400 flex gap-2">
            ...
            <div className="animate-fade-in-up animation-delay-200 flex flex-col h-full overflow-y-auto pb-4">
                ...
                <CardContent className="space-y-4 flex-1 flex flex-col">
                  <form onSubmit={handleLogin} className="space-y-4 flex-1 flex flex-col justify-between">
                    <div className="space-y-2">
                      ...
                      <Input id="email" type="text" placeholder="Enter your email" value={email} onChange={(e) => setEmail(e.target.value)} className="h-10 bg-background/60 backdrop-blur-sm transition-all duration-200" />
                    </div>

                    <div className="space-y-2">
                      <Label htmlFor="password" className="text-sm font-medium text-foreground">Password</Label>
                      <Input id="password" type="password" placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} className="h-10 bg-background/60 backdrop-blur-sm transition-all duration-200" />
                    </div>
